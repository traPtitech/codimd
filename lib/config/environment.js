...
module.exports = {
  ...
  swift: {
    username: process.env.CMD_SWIFT_USERNAME,
    password: process.env.CMD_SWIFT_PASSWORD,
    authUrl: process.env.CMD_SWIFT_AUTH_URL,
    region: process.env.CMD_SWIFT_REGION,
    tenantId: process.env.CMD_SWIFT_TENANT_ID,
    container: process.env.CMD_SWIFT_CONTAINER
  },
  minio: {
