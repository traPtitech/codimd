...
if (config.isTrapEnable) {
  appRouter.get('/', trapAuth.greedyAuth, wrap(indexController.showIndex))
} else {
...
if (config.isTrapEnable) appRouter.use(trapAuth.generousAuth)

if (config.isTrapEnable) {
  // get new note
  appRouter.get('/new', trapAuth.greedyAuth, response.newNote)
  // post new note with content
  appRouter.post('/new', trapAuth.greedyAuth, markdownParser, response.newNote)
} else {
  // get new note
...
appRouter.get('/notes', notes.notesGet)
