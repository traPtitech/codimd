...
function setHistory (userid, history, callback) {
  // Limit history to the latest 500 notes because
  // the MySQL (MariaDB) 'TEXT' datatype limits
  // max length to 65,535 characters.
  // NOTE: PostgreSQL 'TEXT' datatype does limit character length.
  const historyArray = parseHistoryToArray(history)
