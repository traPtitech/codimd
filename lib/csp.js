...
var defaultDirectives = {
  ...
  imgSrc: ['*', 'data:'],
  styleSrc: ['\'self\'', '\'unsafe-inline\'', 'https://github.githubassets.com', 'https://q.trap.jp', 'https://q-dev.trapti.tech'], // unsafe-inline is required for some libs, plus used in views
  fontSrc: ['*', 'data:'],
